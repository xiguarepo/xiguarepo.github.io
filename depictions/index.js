...
$(document).ready(function () {
    ...
    $.getJSON("packages/" + dPackage + ".json", function (data) {
        ...
        if (typeof currentVersion === 'undefined' &&
            ...
            if (supported) {
                result += "你的iOS版本 (" + currentVersion + ") 可以 <strong>兼容</strong> &#x1f607;";
                // $(".version-check").css("color", "green");
                $(".panel-body.version-check").css("background-color", "#a6d841");
            } else{
                result += "<strong>不确定</strong> 在你的iOS版本工作";
        ...
        var extra = {
            "<img class=\"icon\" src=\"icons/twitter.png\"><span>关注我的推特</span>": "https://twitter.com/CNCYRCOM",
            "<img class=\"icon\" src=\"icons/email.png\"><span>发送邮件</span>": "cyr580@qq.com",
            "<img class=\"icon\" src=\"icons/like.png\"><span>暂未开通 &#x1F37A;  <span style=\"font-style:italic;font-weight:bold;\"><span style=\"color:#253b80;\">Pay</span><span style=\"color:#419bd7;\">Pal</strong></span></span>": "https://"
        };
        $.extend(links, extra);
